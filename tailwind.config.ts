    ...
    extend: {
      colors: {
        ...
        sports: {
          ...
          saffron: "hsl(var(--sports-saffron))",
          "saffron-light": "hsl(var(--sports-saffron-light))",
          emerald: "hsl(var(--sports-emerald))",
          "emerald-light": "hsl(var(--sports-emerald-light))",
          navy: "hsl(var(--sports-navy))",
          "navy-light": "hsl(var(--sports-navy-light))",
          gold: "hsl(var(--sports-gold))",
          "gold-light": "hsl(var(--sports-gold-light))",
          maroon: "hsl(var(--sports-maroon))",
          terracotta: "hsl(var(--sports-terracotta))",
        },
      },
      backgroundImage: {
